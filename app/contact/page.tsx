      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <p className="font-sans text-base text-inverse-on-surface/85 leading-relaxed max-w-md">
              If it&apos;s a real quote from a real Melbourne glazier, we come in 30% cheaper —
              in writing, with the same 10-year warranty. Just attach a photo or PDF in the
              message field below.
            </p>
          </div>
          <div className="lg:justify-self-end">
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="flex items-start gap-3 font-sans text-base text-inverse-on-surface/85">
                  <span className="text-primary-container font-bold mt-1 shrink-0">✓</span>
                  {item}
                </li>
              ))}
            </ul>
            <p className="mt-6 font-headline text-xs font-semibold uppercase tracking-wide text-inverse-on-surface/60">
