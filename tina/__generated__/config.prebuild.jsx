  ...
  schema: {
    collections: [
      // ─── Global Settings (site + navigation combined) ─────────────────
      {
        ...
        fields: [
          ...
          { name: "emailCopy", type: "object", label: "Email Copy", fields: [
            ...
            { name: "quoteConfirmIntro", type: "string", label: 'Quote confirm: intro (after "Hi {name} \u2014")', ui: { component: "textarea" } },
            { name: "quoteConfirmSummaryLabel", type: "string", label: "Quote confirm: summary section label" },
            { name: "quoteConfirmContactNote", type: "string", label: "Quote confirm: contact note (use {phone} for the phone number)", ui: { component: "textarea" } },
      ...
      // ─── Pages (block-based) ──────────────────────────────────────────
      {
        ...
        fields: [
          { name: "galleryBlurb", type: "string", label: "Gallery: bottom blurb (optional)", ui: { component: "textarea" } },
          {
            name: "blocks",
            type: "object",
            list: true,
            ...
            templates: [
              ...
              // ── Glass Comparison (Estimate page) ──────────────────────
              {
                ...
                fields: [
                  ...
                  { name: "comparisonNote", type: "string", label: "Hint: comparison footnote", ui: { component: "textarea" } },
                  // Step 1
                  ...
                  { name: "measureInstruction", type: "string", label: "Step 1: measure instruction", ui: { component: "textarea" } },
                  { name: "measureNote", type: "string", label: "Step 1: measure tip", ui: { component: "textarea" } },
                  ...
                  { name: "accuracyNote", type: "string", label: "Step 2: accuracy note (bold)", ui: { component: "textarea" } },
                  { name: "measurementOffNote", type: "string", label: "Step 2: measurement caveat", ui: { component: "textarea" } },
                  { name: "budgetPrompt", type: "string", label: "Step 2: budget prompt", ui: { component: "textarea" } },
                  ...
                  { name: "successBody", type: "string", label: "Success: body", ui: { component: "textarea" } },
