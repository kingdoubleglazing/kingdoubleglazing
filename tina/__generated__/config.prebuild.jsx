  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        ui: { allowedActions: { create: false, delete: false }, global: true },
        fields: [
          { name: "mainNav", type: "object", list: true, label: "Main Nav", ui: { itemProps: (item) => ({ label: item?.label }) }, fields: [
          ...
          { name: "footerServicesNav", type: "object", list: true, label: "Footer: Services", ui: { itemProps: (item) => ({ label: item?.label }) }, fields: [
            { name: "label", type: "string", label: "Label" },
            { name: "href", type: "string", label: "Path" }
          ] },
          { name: "footerCompanyNav", type: "object", list: true, label: "Footer: Company", ui: { itemProps: (item) => ({ label: item?.label }) }, fields: [
            { name: "label", type: "string", label: "Label" },
            { name: "href", type: "string", label: "Path" }
          ] }
        ]
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "heroSubtext", type: "string", label: "Hero Subtext" },
          {
            ...
            ui: { itemProps: (item) => ({ label: item?.id ?? "Section" }) },
            fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "stats", type: "object", list: true, label: "Stats", ui: { itemProps: (item) => ({ label: item?.value }) }, fields: [
          ...
          { name: "guarantees", type: "object", list: true, label: "Guarantees", ui: { itemProps: (item) => ({ label: item?.label }) }, fields: [
            { name: "label", type: "string", label: "Guarantee Label" },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "heroHeadlineYellow", type: "string", label: "Hero Headline (gold)" },
          { name: "heroSubtext", type: "string", label: "Hero Subtext" },
          { name: "coveredItems", type: "object", list: true, label: "What's Covered", ui: { itemProps: (item) => ({ label: item?.item }) }, fields: [
            { name: "item", type: "string", label: "Item Name" },
            { name: "detail", type: "string", label: "Detail", ui: { component: "textarea" } }
          ] },
          { name: "notCoveredItems", type: "object", list: true, label: "What's Not Covered", ui: { itemProps: (item) => ({ label: item?.item }) }, fields: [
            { name: "item", type: "string", label: "Item Name" },
            { name: "detail", type: "string", label: "Detail", ui: { component: "textarea" } }
          ] },
