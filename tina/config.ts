...
const ctaFields = [
  ...
  { name: 'href', type: 'string' as const, label: 'URL' },
]
          ...
          { name: 'galleryBlurb', type: 'string', label: 'Gallery: bottom blurb (optional)', ui: { component: 'textarea' as const } },
          {
            ...
            templates: [
              ...
              // ── Trust Bar ────────────────────────────────────────────
              {
                ...
                fields: [
                  { name: 'items', type: 'object', list: true, label: 'Items', ui: { itemProps: (item: { label?: string }) => ({ label: item?.label ?? 'Item' }) }, fields: [
              ...
              // ── Why Retrofit ─────────────────────────────────────────
              {
                ...
                ui: { itemProps: () => ({ label: '🪟 Why Retrofit' }) },
                fields: [
              ...
              // ── Process Steps ─────────────────────────────────────────
              {
                name: 'processSteps',
                label: 'Process Steps',
                ui: { itemProps: () => ({ label: '📋 Process Steps' }) },
                fields: [
                  { name: 'heading', type: 'string', label: 'Heading' },
                  { name: 'subheading', type: 'string', label: 'Subheading', ui: { component: 'textarea' as const } },
                  { name: 'cta', type: 'object' as const, label: 'CTA Button', fields: ctaFields },
                  {
                    name: 'steps',
                    type: 'object',
                    list: true,
              ...
              // ── Estimate CTA ──────────────────────────────────────────
              {
                name: 'estimateCta',
                label: 'Estimate CTA',
                ui: { itemProps: () => ({ label: '💰 Estimate CTA' }) },
                fields: [
                  { name: 'headline', type: 'string', label: 'Headline' },
                  { name: 'subtext', type: 'string', label: 'Subtext', ui: { component: 'textarea' } },
                  { name: 'cta', type: 'object' as const, label: 'CTA Button', fields: ctaFields },
              ...
              // ── Service Section ───────────────────────────────────────
              {
                ...
                ui: { itemProps: (item: { heading?: string }) => ({ label: `🔧 ${item?.heading ?? 'Service'}` }) },
                fields: [
              ...
              // ── Story With Stats (About page) ─────────────────────────
              {
                name: 'storyWithStats',
                label: 'Story + Stats',
                ui: { itemProps: () => ({ label: '📖 Story + Stats' }) },
                fields: [
                  { name: 'eyebrow', type: 'string', label: 'Eyebrow' },
                  ...
                  { name: 'quote', type: 'string', label: 'Pull Quote', ui: { component: 'textarea' } },
                  {
                    ...
                    list: true,
                    label: 'Stats',
                    ui: { itemProps: (item: { value?: string }) => ({ label: item?.value ?? 'Stat' }) },
                    fields: [
              ...
              // ── Warranty Coverage ─────────────────────────────────────
              {
                ...
                fields: [
                  ...
                  { name: 'notCoveredItems', type: 'object', list: true, label: "What's Not Covered",
                    ui: { itemProps: (item: { item?: string }) => ({ label: item?.item }) },
                    fields: [
                      { name: 'item', type: 'string', label: 'Item Name' },
                      { name: 'detail', type: 'string', label: 'Detail', ui: { component: 'textarea' } },
              ...
              // ── Contact Cards ─────────────────────────────────────────
              {
                name: 'contactCards',
                label: 'Contact Cards',
                ui: { itemProps: () => ({ label: '📞 Contact Cards' }) },
                fields: [
              ...
              // ── Contact Form ──────────────────────────────────────────
              {
                name: 'contactForm',
                label: 'Contact Form',
                ui: { itemProps: () => ({ label: '📝 Contact Form' }) },
                fields: [
              ...
              // ── CTA Banner ────────────────────────────────────────────
              {
                name: 'ctaBanner',
                label: 'CTA Banner',
                ui: { itemProps: (item: { heading?: string }) => ({ label: `📣 CTA: ${item?.heading?.slice(0, 30) ?? ''}` }) },
                fields: [
                  { name: 'heading', type: 'string', label: 'Heading' },
                  { name: 'subtext', type: 'string', label: 'Subtext', ui: { component: 'textarea' } },
              ...
              // ── Adaptor Disclosure ────────────────────────────────────
              {
                ...
                ui: { itemProps: () => ({ label: '📏 Adaptor Disclosure' }) },
                fields: [
                  { name: 'heading', type: 'string', label: 'Heading' },
              ...
              // ── Free Advice CTA ───────────────────────────────────────
              {
                ...
                ui: { itemProps: () => ({ label: '💡 Free Advice' }) },
                fields: [
                  { name: 'eyebrow', type: 'string', label: 'Eyebrow' },
              ...
              // ── What Else Strip ───────────────────────────────────────
              {
                ...
                ui: { itemProps: () => ({ label: '📌 What Else Strip' }) },
                fields: [
                  { name: 'eyebrow', type: 'string', label: 'Eyebrow' },
                  { name: 'heading', type: 'string', label: 'Heading' },
                  { name: 'cta', type: 'object' as const, label: 'CTA Button', fields: ctaFields },
                  { name: 'services', type: 'object', list: true, label: 'Service links', ui: { itemProps: (item: { label?: string }) => ({ label: item?.label ?? 'Service' }) }, fields: [
                    { name: 'label', type: 'string', label: 'Label' },
              ...
              // ── Emergency Strip ───────────────────────────────────────
              {
                ...
                ui: { itemProps: () => ({ label: '🚨 Emergency Strip' }) },
                fields: [
                  { name: 'boldText', type: 'string', label: 'Bold text' },
                  { name: 'text', type: 'string', label: 'Text after bold' },
                  { name: 'cta', type: 'object' as const, label: 'CTA Link', fields: ctaFields },
                ],
              },
              // ── Owner Bio (Meet the Owner — Tas) ──────────────────────
              {
                name: 'ownerBio',
                label: 'Owner Bio',
                ui: { itemProps: (item: { name?: string }) => ({ label: `👤 Owner: ${item?.name ?? 'Tas'}` }) },
                fields: [
                  ...
                  { name: 'paragraphs', type: 'string', list: true, label: 'Bio Paragraphs', ui: { component: 'textarea' as const } },
                  { name: 'quote', type: 'string', label: 'Pull Quote (optional)', ui: { component: 'textarea' as const } },
                  { name: 'cta', type: 'object' as const, label: 'CTA Button (optional)', fields: ctaFields },
                ],
              },
            ],
          },
