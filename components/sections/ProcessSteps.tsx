...
interface ProcessStepsProps {
  ...
  tinaCta?: string
  tinaSteps?: ReadonlyArray<{ title?: string; body?: string; callout?: string } | undefined>
}
...
export function ProcessSteps({
  ...
  return (
    <section data-tina-field={tinaSelf} className="bg-inverse-surface py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-4">
        ...
        {(heading || subheading || cta) && (
          <div className="mb-12 md:mb-16 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            {cta && <GoldLinkButton label={cta.label} href={cta.href} tinaField={tinaCta} />}
          </div>
        )}
            ...
            return (
              ...
              >
                ...
                <div className="md:mt-6 pb-12 md:pb-0">
                  ...
                  {step.title && (
                    <h3
                      data-tina-field={tinaSteps?.[i]?.title}
                  ...
                  {step.body && (
                    <p
                      data-tina-field={tinaSteps?.[i]?.body}
                  ...
                  {step.callout && (
                    <p
                      data-tina-field={tinaSteps?.[i]?.callout}
