  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Header */}
        <div className="mb-8 md:mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          <div>
        ...
        <div className="ghost-border">
          {items.map((item, i) => (
            <details
              ...
              style={{ '--i': i } as any}
            >
              <summary className="flex items-start justify-between gap-3 md:gap-6 cursor-pointer list-none px-4 py-4 md:px-7 md:py-6 select-none [&::-webkit-details-marker]:hidden">
                {/* Number + question */}
                ...
                <div className="shrink-0 mt-0.5 md:mt-1 w-5 h-5 md:w-6 md:h-6 bg-surface-container-high group-open:bg-primary-container flex items-center justify-center transition-colors duration-150">
                  <span
